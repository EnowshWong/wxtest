...
////		var i=0;
////		while(i<100){
////			var pt1=document.getElementsByClassName("pt1");
////			var pt2=document.getElementsByClassName("pt2");
////			pt1[0].onmouseover = function() {
////				pt2[0].style.display = "";
////			};
////			pt1[0].onmouseout = function() {
////				pt2[0].style.display = "none";
////			};
////      		i++;
//		
...
//
    function showSubSearch() {
			...
			pt1[1].onmouseover=function(){
				pt2[1].style.display="";
			};
			pt1[1].onmouseout=function(){
				pt2[1].style.display="none";
			};
			pt1[2].onmouseover=function(){
				pt2[2].style.display="";
			};
			pt1[2].onmouseout=function(){
				pt2[2].style.display="none";
			};
